...
<details>
<summary>❗ pg_connection_test1.sh ❗</summary>
...
<details>
<summary>❗ pg_connection_test3.sh ❗</summary>
...
# УНИВЕРСАЛЬНАЯ ПРОВЕРКА FD
echo "=== FD Check ==="

# Способ 1: Через systemd (если запущен через systemd)
...
# Способ 2: Прямой запуск (через PID файл)
...
# Способ 3: Через pgrep (последний вариант)
else
...
# Проверяем лимиты (если процесс найден)
