...
## Содержание
1. [Настройка лимитов файлов в Proxmox для unprivileged контейнеров](#1-настройка-лимитов-файлов-в-proxmox-для-unprivileged-контейнеров)
2. [Установка и базовая настройка HAProxy в Debian 12](#2-установка-и-базовая-настройка-haproxy-в-debian-12)
3. [Настройка лимитов файловых дескрипторов для HAProxy в Debian 12](#3-настройка-лимитов-файловых-дескрипторов-для-haproxy-в-debian-12)
4. [Тестирование HAProxy с PostgreSQL](#4-тестирование-haproxy-с-postgresql)
...
1. Настройку лимитов файловых дескрипторов в Proxmox LXC контейнерах
2. Установку и базовую настройку HAProxy в Debian 12
3. Детальную настройку лимитов для HAProxy через systemd
4. Тестирование HAProxy с PostgreSQL для проверки работы под нагрузкой

Теперь HAProxy настроен для обработки тысяч одновременных подключений к PostgreSQL кластеру в пределах системных лимитов.
