...
echo "=== Final HAProxy Limits Check ==="
echo ""

echo "1. LXC Container Limits:"
cat /proc/1/limits | grep "Max open files"

echo ""
echo "2. HAProxy Process Limits:"
cat /proc/$(systemctl show haproxy -p MainPID --value)/limits | grep "Max open files"

echo ""
echo "3. Current HAProxy FD Usage:"
ls -la /proc/$(systemctl show haproxy -p MainPID --value)/fd/ | wc -l

echo ""
echo "4. HAProxy Status:"
systemctl status haproxy --no-pager -l
...
echo "Global maxconn: 25000"
echo "Core maxconn: 35000" 
echo "Core_ESL maxconn: 35000"
echo "CDR maxconn: 25000 (global)"
echo "Total estimated: ~65000 FD"
echo "System limit: 65536 FD"
```
