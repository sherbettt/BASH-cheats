...
НО лучше так не делать, чтобы не потерять основной ресурс. ***См. конфиг `teleport.yaml` почему именно.***
...
***Однако, можно "жить" и с прямым доменным именем, без смены `Base URL`, как указано в настройках `teleport.yaml`. Делайте самим свой выбор.***
