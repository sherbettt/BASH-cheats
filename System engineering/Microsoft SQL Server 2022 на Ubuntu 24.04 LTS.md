...
## ⚠️ Важное замечание
Данная инструкция описывает "обходной" путь установки на неофициально поддерживаемую ОС. Это решение **отлично подходит для разработки и тестирования**, но для **продуктивных сред** настоятельно рекомендуется использовать официально поддерживаемые дистрибутивы, такие как Red Hat Enterprise Linux, SUSE Enterprise Linux или Ubuntu 22.04.
