...
## Просто создать пустые БД
```bash
# Создаем 4 абсолютно пустые БД
psql -h /var/lib/postgresql/patroni -p 5433 -U postgres -c "
CREATE DATABASE rt_pbx_v2_ext 
    WITH 
    OWNER = rt_pbx
    ENCODING = 'UTF8'
...
CREATE DATABASE rt_pbx_v2_logging_ext 
    WITH 
    OWNER = rt_pbx
    ENCODING = 'UTF8'
    LC_COLLATE = 'ru_RU.UTF-8'
...
CREATE DATABASE rt_pbx_v2_media_ext 
    WITH 
    OWNER = rt_pbx
    ENCODING = 'UTF8'
    LC_COLLATE = 'ru_RU.UTF-8'
...
CREATE DATABASE rt_pbx_v2_stat_ext 
    WITH 
    OWNER = rt_pbx
    ENCODING = 'UTF8'
    LC_COLLATE = 'ru_RU.UTF-8'
