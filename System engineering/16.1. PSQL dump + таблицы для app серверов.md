...
# 2. Бэкап глобальных объектов (роли) - ТОЛЬКО НА МАСТЕРЕ!
...
```bash
# Посмотреть размеры таблиц в pbxv2 (самая большая наверное)
...
# Посмотреть размеры таблиц в rt_pbx_v2_71
...
**Сколько места займет?** Зависит от размера БД. Проверьте командой из пункта 6.
<br/>
