...
Отличный вопрос! Разберём основы работы с NGINX по пунктам.
...
Это основа, на которой строится всё остальное: кэширование, балансировка нагрузки, безопасность, редиректы. Начинай с простых статических сайтов, потом переходи к проксированию.
