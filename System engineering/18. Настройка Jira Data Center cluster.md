...
upstream jira_servers {
    server 192.168.46.2:443;
    server 192.168.46.3:443 backup;
    server 192.168.46.4:443 backup;
}
...
За основу использован пример из статьи **[System engineering/17. keycloak: резервный сервер.md](https://github.com/sherbettt/BASH-cheats/blob/main/System%20engineering/17.%20keycloak%3A%20резервный%20сервер.md)**
