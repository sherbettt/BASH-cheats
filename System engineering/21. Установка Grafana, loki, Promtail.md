...
### 1. Query - Основные запросы логов
...
logcli query --addr=http://localhost:3100 '{job="varlogs"}' --from="2024-01-15T10:00:00Z" --to="2024-01-15T12:00:00Z"
...
### 2. Instant-Query - Мгновенные запросы
...
logcli stats --addr=http://localhost:3100 '{service_name=~"runtel.*"}' --from="2024-01-15T00:00:00Z" --to="2024-01-15T23:59:59Z"
...
logcli volume-range --addr=http://localhost:3100 '{service_name=~".*"}' --from="2024-01-15T00:00:00Z" --to="2024-01-15T23:59:59Z" --step=1h
