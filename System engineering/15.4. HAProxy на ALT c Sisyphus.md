...
```bash
root@file-ALT11 ~ > ccat /etc/haproxy/haproxy.cfg
#---------------------------------------------------------------------
...
- Изучили готовый конфиг с примерами фронтендов и бэкендов
...
echo '<h1>Hello from HAProxy!</h1><p>Server: '$(hostname)'</p>' > /var/www/html/index.html
```
