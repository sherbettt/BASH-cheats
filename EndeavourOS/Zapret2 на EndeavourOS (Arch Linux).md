...
Этот способ подойдёт, если вы хотите использовать **конкретную стабильную версию**.
...
**Когда это нужно:** Если вы хотите получить самые свежие изменения из репозитория, которые ещё не вошли в стабильный релиз. Например, новые стратегии обхода или исправления багов.
...
| **GitHub релиз** | ⭐⭐ | ❌ | Вручную | Нужна конкретная версия |
| **GitHub master** | ⭐⭐⭐ | ✅ | `git pull` + make | Нужны свежие изменения |
...
**Ожидаемый вывод:** `HTTP/2 301` или `HTTP/2 200` — установка прошла успешно! 🎉
