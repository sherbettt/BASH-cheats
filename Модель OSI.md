...
Если нужно добавить в таблицу, можно указать его в **прикладном уровне** с пометкой:  
> *«SDP (описание сеанса) — используется SIP (5060), RTSP (554) или WebRTC (динамические порты)»*.  

Нужны ли детали по другим связанным протоколам (например, RTSP, SRTP)?
