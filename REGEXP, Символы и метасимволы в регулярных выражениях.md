 ...
 **Мобильные номера РФ код аббоненнат - 7 последних цифр**
<br/> ` (?:8|7|\+7)\d{3}(\d{7}) `
...
<br/> (+ 374 + код города + номер абонента ; +[374][12]123456, +[374][478]123456, +[374][312]123456)
<br/> ` \+374(\d{2}\d{6}|\d{3}\d{6})(?:\D|$) ` , либо
<br/> ` \+374(\d{8,9})(?:\D|$) ` , либо
<br/> ` \+374(\d{2,3})(\d{6})(?:\D|$) `


**Номера Армении +374 без кода города**
<br/> ` \+374(?:\d{2}|\d{3})(\d{6})(?:\D|$) ` , либо
<br/> ` \+374\d{2,3}(\d{6})(?:\D|$) `
