Вот обновлённая статья с двумя новыми разделами: настройкой времени до затемнения экрана и включением автоматического поворота экрана в EndeavourOS.

---

# Установка и настройка Chuwi MiniBook X в Linux

Данное руководство содержит полный цикл настроек для комфортной работы на ноутбуке-трансформере Chuwi MiniBook X в двух дистрибутивах: **Ximper Linux** (ALT Linux based) и **EndeavourOS** (Arch based) с окружением Budgie.
