...
<br/> Однако, есть страннеы баги с переключением языка, его попросту нет после установки, даже если в момент уставноки задаёшь язык и переключение языка по Caps.
