...
alias getip3='curl -s https://yandex.ru/internet | grep -oE '([0-9]{1,3}\.){3}[0-9]{1,3}' '
...
# Simple color PS1
# PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;196m\]\u\[\033[01;38;5;226m\]@\[\033[01;38;5;51m\]\h \[\033[01;38;5;226m\]\w \[\033[01;38;5;201m\]\$ \[\033[00m\]'
