...
# (пользователь) Ярко-зелёный / (хост) Ярко-пурпурный / (рабочая директория) Ярко-жёлтый / (приглашение) Ярко-красный
#PS1='\[\033[1;32m\]\u\[\033[1;36m\]@\[\033[1;35m\]\h \[\033[1;33m\]\w \[\033[1;31m\]\$\[\033[0m\] '

# \u Ярко-зелёный; @ Белый (обычный); \h Ярко-зелёный; : Белый (по умолчанию); \w Ярко-синий; \$ Белый (по умолчанию)
#PS1='\[\033[01;32m\]\u\[\033[00;37m\]@\[\033[01;32m\]\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '

# с кодом ошибки последней операции
#PS1='\[\033[01;31m\]\u\[\033[01;33m\]@\[\033[01;32m\]\h\[\033[01;31m\]($?)\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
...
# Компактный яркий PS1 с полным путём и часами (Код ошибки с индикатором ✔/✘)
PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;196m\]\u\[\033[01;38;5;28m\]@\[\033[01;38;5;82m\]\h \[\033[01;38;5;28m\]\w\[\033[01;38;5;240m\] $( [ $? -eq 0 ] && echo "\[\033[01;38;5;82m\]✔" || echo "\[\033[01;38;5;196m\]✘ $?" )\n\[\033[01;38;5;226m\]\t \[\033[01;38;5;51m\]> \[\033[00m\]'

# Минималистичный (код в серых скобках)
PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;196m\]\u\[\033[01;38;5;28m\]@\[\033[01;38;5;82m\]\h \[\033[01;38;5;28m\]\w\[\033[01;38;5;240m\]($?)\n\[\033[01;38;5;226m\]\t \[\033[01;38;5;51m\]> \[\033[00m\]'

# Компактный яркий PS1 с полным путём и часами и кодом ошибки
PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;196m\]\u\[\033[01;38;5;28m\]@\[\033[01;38;5;82m\]\h \[\033[01;38;5;28m\]\w \[\033[01;38;5;214m\]($?)\n\[\033[01;38;5;226m\]\t \[\033[01;38;5;51m\]> \[\033[00m\]'

# Тёплая природная гамма (землистые тона)
PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;130m\]\u\[\033[01;38;5;142m\]@\[\033[01;38;5;71m\]\h \[\033[01;38;5;143m\]\w\[\033[01;38;5;245m\]($?)\n\[\033[01;38;5;179m\]\t \[\033[01;38;5;110m\]> \[\033[00m\]'

# Пастельная гамма (мягкие, уютные цвета)
PS1='${debian_chroot:+($debian_chroot)}\[\033[01;38;5;174m\]\u\[\033[01;38;5;114m\]@\[\033[01;38;5;80m\]\h \[\033[01;38;5;150m\]\w\[\033[01;38;5;247m\]($?)\n\[\033[01;38;5;180m\]\t \[\033[01;38;5;117m\]> \[\033[00m\]'
...
alias top-z='top -b -n 1 | grep -E " Z "'
...
alias paru-update-show='paru -Qu 2>/dev/null || echo "Нет обновлений"'
alias paru-update-all='paru -Syu --noconfirm --quiet'
alias paru-update-aur='paru -Syu --noconfirm --aur'
...
alias batp='bat -pP --theme=zenburn'
