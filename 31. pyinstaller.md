...
pipx устанавливает Python-приложения (не библиотеки!) в изолированные виртуальные окружения и делает их доступными глобально.

Установка
```bash
apt search pipx; apt install -y pipx;

# Установить приложение (pipx создаст venv автоматически)
pipx install pyinstaller
pipx install black          # форматировщик кода
pipx install httpie         # HTTP клиент
pipx install poetry         менеджер зависимостей

# Теперь можно использовать глобально
pyinstaller --version
pipx --version
```
...
# Запустить приложение без установки
pipx run pycowsay moo!

# Установить конкретную версию
pipx install "pyinstaller==5.0"

# Обновить
pipx upgrade pyinstaller

# Удалить
pipx uninstall pyinstaller

# Показать информацию
pipx inspect pyinstaller
```
...
###  **Для нашего случая с PyInstaller**
