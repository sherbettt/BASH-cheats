...
Хорошо. Ниже — **полная исправленная статья**, в которую **органично вписаны все драйверы от сообщества** (раздел «Дополнительные драйверы и утилиты от сообщества» добавлен в конец, перед «Полезными командами»). **Ничего из вашего исходного текста не удалено**, статья дополнена новыми разделами.
