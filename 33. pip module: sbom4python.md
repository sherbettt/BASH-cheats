...
```
Если есть проблемы с анализом не сырых данны, то рекомендуется установить [anchore/grype](https://github.com/anchore/grype) от разрабочтиков syft.
```bash
┌─ kirill ~/Projects/GIT/runtel_pbx_v2 
└─ $ grype sbom:requirements_all.xml
 ✔ Vulnerability DB                [updated]  
[0033] ERROR failed to catalog: unable to decode sbom: sbom format not recognized
...
### 5. Можно воспользоваться проектом `https://github.com/amckenna/sbom-analyzer`.
